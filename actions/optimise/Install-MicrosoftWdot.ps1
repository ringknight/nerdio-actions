#description: Downloads the Microsoft Windows Desktop Optimization Tool and optimises the OS. Ensure 014_RolesFeatures.ps1 and 015_Customise.ps1 are run
...
# Download Microsoft Windows Desktop Optimization Tool
$App = Get-EvergreenApp -Name "MicrosoftWdot" | Select-Object -First 1
$OutFile = Save-EvergreenApp -InputObject $App -CustomPath $Path -ErrorAction "Stop"
Write-LogFile -Message "Microsoft Windows Desktop Optimization Tool $($App.Version) downloaded to: $($OutFile.FullName)"
Expand-Archive -Path $OutFile.FullName -DestinationPath $Path -Force
$Installer = Get-ChildItem -Path $Path -Recurse -Include "Windows_VDOT.ps1"
Write-LogFile -Message "Starting Microsoft Windows Desktop Optimization Tool from: $($Installer.FullName)"

# Compress the log files - the Windows Desktop Optimization Tool will delete .log files
...
# Run Microsoft Windows Desktop Optimization Tool
