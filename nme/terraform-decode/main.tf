...
# Note: Log Analytics Data Sources have been moved to monitoring.tf
# Apply separately after main infrastructure: terraform apply -var="resource_group_name=<name>"
